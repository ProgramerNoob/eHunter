...
功能用例和完成标准见 [AGENTS.md](../AGENTS.md) 与对应 `specs/**/quickstart.md`。EH 生产包验收使用 [eh-test](skills/eh-test/SKILL.md)。本文只维护通用浏览器操作。
...
- 按 [notify-complete](skills/notify-complete/SKILL.md) 在测试开始前执行短通知。
