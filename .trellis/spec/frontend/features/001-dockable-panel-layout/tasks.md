...
> 迁移来源：`specs/001-dockable-panel-layout/tasks.md`（基线 `647ff26`）。正文保全，路径已重定位；命令与源码路径均从仓库根目录解释。
...
**Input**: Design documents from `.trellis/spec/frontend/features/001-dockable-panel-layout/`
...
- [X] T025 [P] [US3] Align reader layout preference contract with implemented payload fields in `.trellis/spec/frontend/features/001-dockable-panel-layout/contracts/layout-contract.openapi.yaml`
- [X] T026 [US3] Document block onboarding steps for future extensions in `.trellis/spec/frontend/features/001-dockable-panel-layout/quickstart.md`
...
- [X] T027 [P] Review and tighten edge-case handling notes in `.trellis/spec/frontend/features/001-dockable-panel-layout/spec.md`
- [X] T028 Run static validation (`npm run type-check`) and record results in `.trellis/spec/frontend/features/001-dockable-panel-layout/plan.md`
- [X] T029 Run runtime verification (`npm run dev` + browser verification) and record outcomes in `.trellis/spec/frontend/features/001-dockable-panel-layout/plan.md`
- [X] T030 [P] Update feature validation checklist with final manual pass criteria in `.trellis/spec/frontend/features/001-dockable-panel-layout/checklists/requirements.md`
...
```bash
Task T025 in .trellis/spec/frontend/features/001-dockable-panel-layout/contracts/layout-contract.openapi.yaml
Task T026 in .trellis/spec/frontend/features/001-dockable-panel-layout/quickstart.md
```
