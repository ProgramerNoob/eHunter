...
> 迁移来源：`specs/001-platform-injection/plan.md`（基线 `647ff26`）。正文保全，路径已重定位；命令与源码路径均从仓库根目录解释。
...
**Input**: Feature specification from `.trellis/spec/frontend/features/001-platform-injection/spec.md`
...
```text
.trellis/spec/frontend/features/001-platform-injection/
