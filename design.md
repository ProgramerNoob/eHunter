...
## 已确认决策
本文描述产品目标，不代表当前实现已全部完成。涉及下载格式、翻页默认值、偏好存储/迁移和放大镜时，先读取 [2026-09-18 决策记录](specs/decisions/2026-09-18-reader-behavior.md)，按其中已确认规则修改和验收；记录同时列出待同步规格与待修正实现。
...
- 书页模式翻页动效支持用户下拉配置：
  ...
  - 平移切屏
  - 无动效直接切页
- 翻页初始化、已存偏好优先级与系统偏好生效时机遵循 [已确认决策](specs/decisions/2026-09-18-reader-behavior.md)。
...
### 配置存储
- 共享范围、GM 优先及本站存储降级、旧偏好补缺顺序以 [已确认决策](specs/decisions/2026-09-18-reader-behavior.md) 为准。
